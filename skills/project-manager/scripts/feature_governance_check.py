...
CHECKERS = [
    ...
    },
    {
        ...
        "args": lambda docs, feature, issue, stage: ["--prd", str(docs / "product" / f"{feature}.md"), "--issue", issue] if issue else ["--prd", str(docs / "product" / f"{feature}.md")],
    },
    {
        "name": "ui-design-checker",
        "from_stage": "design",
        "script": "ui_design_checker.py",
        "args": lambda docs, feature, issue, stage: ["--ui", str(docs / "design" / f"{feature}.md"), "--issue", issue] if issue else ["--ui", str(docs / "design" / f"{feature}.md")],
    },
    {
        "name": "test-case-checker",
        "from_stage": "development",
        "script": "test_case_checker.py",
        "args": lambda docs, feature, issue, stage: ["--testcase", str(docs / "testing" / f"{feature}-test-cases.md"), "--issue", issue] if issue else ["--testcase", str(docs / "testing" / f"{feature}-test-cases.md")],
    },
    {
        "name": "architecture-design-checker",
        "from_stage": "development",
        "script": "architecture_design_checker.py",
        "args": lambda docs, feature, issue, stage: ["--design", str(docs / "development" / f"{feature}.md"), "--issue", issue] if issue else ["--design", str(docs / "development" / f"{feature}.md")],
    },
    {
        "name": "api-contract-checker",
        "from_stage": "development",
        "script": "api_contract_checker.py",
        "args": lambda docs, feature, issue, stage: ["--input", str(docs / "development/openapi/openapi.yaml")],
    },
    {
        "name": "test-report-checker",
        "from_stage": "release",
        "script": "test_report_checker.py",
        "args": lambda docs, feature, issue, stage: ["--input", str(docs / "testing" / f"{feature}-test-report.md")],
    },
    {
        "name": "retrospective-checker",
        "from_stage": "closure",
        "script": "retrospective_checker.py",
        "args": lambda docs, feature, issue, stage: ["--input", str(docs / "retrospective" / f"{feature}-retro.md")],
    },
    {
