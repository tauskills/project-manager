...
class CheckerExampleTests(unittest.TestCase):
    def test_prd_example_is_allowed(self) -> None:
        markdown = (REPO_ROOT / "references/examples/prd-example-input.md").read_text(encoding="utf-8")
    ...
    def test_release_example_is_allowed(self) -> None:
        markdown = (REPO_ROOT / "references/examples/release-example-input.md").read_text(encoding="utf-8")
